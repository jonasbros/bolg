                ...
                <div class="d-inline-block">
                    <div class="post-author-pic" :style="'background-image: url(' + post.author_dp + ')'">
                        ...
                        <div class="post-share">
                            <p>Share: </p>
                            <a :href="'https://www.facebook.com/sharer/sharer.php?u='+ encodeURI('https://jonasbros.github.io/bolg/post/'+ $options.filters.replaceSpaceWithDash(post.title) + '/' + post.id) +'&amp;src=sdkpreparse'"
                                target="_blank">            
